...
const uri =`mongodb+srv://${process.env.REACT_APP_DB_USER}:${process.env.REACT_APP_DB_PASSWORD}@job-portal-demo.sbmsc.mongodb.net/?retryWrites=true&w=majority&appName=job-portal-demo`;
